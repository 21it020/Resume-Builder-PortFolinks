...
export interface ApiUserResumeUserResume extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userName: Schema.Attribute.String;
    usersEmail: Schema.Attribute.Email;
  };
}

export interface ApiUserResumes123UserResumes123
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_resumes123s';
  info: {
    description: '';
    displayName: 'User Resumes123';
    pluralName: 'user-resumes123s';
    singularName: 'user-resumes123';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-resumes123.user-resumes123'
    > &
      Schema.Attribute.Private;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resumId: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-resumes123.user-resumes123': ApiUserResumes123UserResumes123;
